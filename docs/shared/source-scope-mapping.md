# Source Scope Mapping Protocol

## Overview

This protocol defines the 5-step process for constructing the analysis source pool. The source pool is the collection of data sources that analysts will consult during multi-perspective analysis. It ensures that all relevant sources are discovered, selected, and made accessible before analysis begins.
...
2. Offer options:
   ...
   - **Cancel** -- Abort the source scope mapping
